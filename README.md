...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-37pf8ju.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-37pf8ju.containers.anotherwebservice.com/
...
```
git clone git@github.com:asin0622/container-37pf8ju.git
cd container-37pf8ju
```
...
```
docker attach container-37pf8ju
```
